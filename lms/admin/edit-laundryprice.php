...
if(isset($_POST['submit']))
  {
   ...
   $query=mysqli_query($con, "update tblpricelist set TopWear='$topwear',  BottomWear='$bottomwear',  Woolen='$woolen' ,Bedsheet='$bedsheets' where Id='$eid'");
    if ($query) {
...
?>
          ...
          <div class="form-group">
            <div class="form-label-group">
              <input type="text" id="bedsheets" name="bedsheets" class="form-control"  required="required" value="<?php  echo $row['Bedsheet'];?>">
              <label for="woolen">Bedsheet Price</label>
            </div>
          </div>
