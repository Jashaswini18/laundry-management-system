...
<tr>
    ...
    <th>Bedsheet</th>
    <td><?php  echo $bqty=$row['Bedsheet'];?></td>
...
<tr>
  ...
  <th><?php echo $twqty+$bwqty+$wcqty+$bqty+$thrqyty;?></th>
    <td></td>
      <th><?php echo $twqty*$twp+$bwqty*$bwp+$wcqty*$wwp+$bqty*$bp+$otchpr;?></th>
</tr>
</table>
</div>
<tr>
